...
class Tax(models.Model):
    ...
    stripe_tax_rate_id = models.CharField(max_length=255, verbose_name="ID из панели Stripe")
...
class Item(models.Model):
    ...
    image = models.ImageField(upload_to='items/', null=True, blank=True,verbose_name='Фото')
    ...
    categories = models.ManyToManyField(Category, related_name='items',verbose_name='Категория товара')
